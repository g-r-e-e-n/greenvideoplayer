...
async def reply(client, message): 
    try:
        inline = await client.get_inline_bot_results(Config.BOT_USERNAME, "yaro orutha pm senju")
        ...
        await message.reply(f"{Config.REPLY_MESSAGE}\n\n<b>You can't use this bot in your group.</b>", disable_web_page_preview=True)
