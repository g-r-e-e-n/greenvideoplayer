...
async def notforu(_, m: Message):
    k = await _.send_cached_media(chat_id=m.chat.id, caption="You Are Not Authorized", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton('help', callback_data='help_main')]]))
    await delete_messages([m, k])
